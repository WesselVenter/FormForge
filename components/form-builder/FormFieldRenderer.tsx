...
export default function FormFieldRenderer({ field }: FormFieldRendererProps) {
      ...
      case 'file':
        return (
          <div className={`${widthClass}`}>
            ...
            <label
              htmlFor={field.id}
              className="flex items-center justify-center w-full h-32 border-2 border-dashed border-neutral-300 rounded-medium cursor-pointer hover:border-primary-400 hover:bg-primary-50 transition-colors duration-150"
            >
