-- Migration: add_analytics_and_file_tracking
-- Created at: 1765958831
...
ALTER TABLE submissions ADD COLUMN IF NOT EXISTS session_id VARCHAR(255);
 COLUMN IF NOT EXISTS completion_time INTEGER; -- seconds
ALTERALTER TABLE submissions ADD TABLE submissions ADD COLUMN IF NOT EXISTS fields_completed INTEGER DEFAULT 0;
